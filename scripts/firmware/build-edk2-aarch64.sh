...
EXPECTED_SHA256="${VORTEX_FIRMWARE_EXPECTED_SHA256:-6748b7f9ca864e47c565cc2d5fbc2a3133a3e08b56eeab52ff55fe0cd642a16e}"
EXPECTED_SIZE="${VORTEX_FIRMWARE_EXPECTED_SIZE:-67108864}"
...
"${ENGINE}" run --rm \
    -e "SOURCE_DATE_EPOCH=${EDK2_SOURCE_DATE_EPOCH}" \
    -e TZ=UTC \
